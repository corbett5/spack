...
class Hypre(Package, CudaPackage):
    ...
    version('2.20.1', commit='2186a8fb343f84f109405eed3e298cb1a2615e95') # Note this is not the official release.
    ...
    variant('cusparse', default=False, description='Use cusparse')
    ...
    def _configure_args(self):
        ...
        if '+cusparse' in self.spec:
            configure_args.append('--enable-cusparse')
